...
class UserRetrieveSerializer(WritableNestedModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['name', 'email', 'status', 'birthday', 'mbti', 'interest', 'created_at', 'updated_at']
