...
class UserUpdateSerializer(WritableNestedModelSerializer): 
    ...
    def update(self, instance, validated_data):
        ...
        instance.location = Country.objects.get(name=country_name)['id']

        # country_id = Country.objects.get(name=validated_data.get('country.name'))
        # instance.country = validated_data.get('country.name', instance.country)
        instance.save()
        return instance
