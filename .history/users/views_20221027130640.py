...
class UserInfoUpdateAPI(generics.UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        try: 
          ...
          # String -> Date 
          registration_number = request.data['registration_number'].split('/')
          request.data['birthday'] = self.get_birthday(registration_number)
          request.data['is_male'] = self.get_gender(registration_number)
    ...
    def get_birthday(self, registration_number): 
    ...
    def get_gender(self, registration_number): 
        is_male = True 
        if registration_number[3] == '1' or registration_number[3] == '3' or registration_number[3] == '5' or registration_number[3] == '7':
           is_male = True
        elif registration_number[3] == '1' or registration_number[3] == '3' or registration_number[3] == '5' or registration_number[3] == '7':
           is_male = False
        else :
           raise ValueError('주민등록번호 7번쨰 자리 수가 유효하지 않습니다')
        return is_male
