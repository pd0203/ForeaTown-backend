...
class Nofilter_highschool_rating(models.Model):
    nofilter_highschool_id = models.ForeignKey(Nofilter_highschool, on_delete=models.CASCADE, related_name='rating')
...
class Nofilter_user_info(models.Model):
    ...
    nofilter_highschool = models.ForeignKey(Nofilter_highschool, null=True, blank=False, on_delete=models.CASCADE, related_name="userinfo")
