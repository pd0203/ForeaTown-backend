...
from users.views import KakaoLogin, kakao_login, UserAdditionalInfoAPI, LoginAPI, SignupAPI
urlpatterns = [
    path('', include('dj_rest_auth.urls')),
    path('user', UserAdditionalInfoAPI.as_view({'get': 'retrieve', 'put': 'update'}), name='user'),
    path('user/list', UserAdditionalInfoAPI.as_view({'get': 'list'}), name='user_list'),
