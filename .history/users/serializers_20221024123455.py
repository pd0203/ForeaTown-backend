...
from nofilter.models import Post, Comment, Recomment, UserPostLikes
...
class UserReadSerializer(WritableNestedModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['name', 'email', 'password', 'user_post_likes', 'is_active', 'created_at',
                  'updated_at', 'deleted_at', 'nofilter_user_info']


class UserPostSerializer(serializers.ModelSerializer):
    nofilter_user_info = NofilterUserReadSerializer()
    # nofilter_highschool_rating = NofilterHighschoolRatingSerializer()
