...
from users.models import User, Nofilter_highschool_rating, Nofilter_highschool
from users.serializers import UserRegisterSerializer, UserReadSerializer, UserPostSerializer, NofilterHighschoolRatingCreateSerializer
...
class PostListSerializer(serializers.ModelSerializer):
    # creator = serializers.ReadOnlyField(source='User.name')
...
class PostFileUploadSerializer(serializers.ModelSerializer):
    # postfile = serializers.ImageField()
...
class PostSerializer(serializers.ModelSerializer):
    category = serializers.StringRelatedField()
    # postfile = PostFileSerializer(many=True, read_only=True)
...
#     images = PostFileUploadSerializer()
#     post = PostSerializerSub()
...
#         for image_data in image_set.getlist('postfile'):
#             print("!!!!!!!!!!!!")
#             PostFile.objects.create(post=instance, file_url=image_data)
#         print(instance)
