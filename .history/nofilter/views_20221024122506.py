...
from .serializers import PostSerializer, PostListSerializer, PostCreateSerializer, PostSerializerCreate, PostCreateSerializer, PostFileUploadSerializer, PostDetailViewSerializer, ReviewPostCreateSerializer, PostRatingSerializer, PostRatingPostSerializer, CommentSerializer, CommentCreateSerializer, RecommentSerializer
from users.serializers import UserReadSerializer, NofilterHighschoolReadSerializer, UserPostSerializer, NofilterHighschoolRatingSerializer, NofilterHighschoolRatingCreateSerializer
from .models import Post, Category, PostRating, Comment, Recomment, UserPostLikes
from users.models import User, Nofilter_highschool, Nofilter_user_info, Nofilter_highschool_rating
from rest_framework_simplejwt.authentication import JWTAuthentication
from nofilter.settings import SIMPLE_JWT
from users.views import user_validator, status_validator
from .permissions import CustomReadOnly
from .schemas import POST_LIST_CATEGORY
# from nofilter.exception import handle_exception, custom_exception_handler
...
class PostRecommentView(generics.ListCreateAPIView):
    ...
    def post(self, request, id):
        ...
        except Reccomment.DoesNotExist:
